...
def preProcess(rowCount):
    ...
    for file in files:
       ...
       if data.shape[0] > rowCount:
           ...
           print("No. of rows is less than", rowCount)
...
import joblib
joblib.dump(svm_classifier, 'preimpactClassifier_svm.pkl', compress=9) 
...
joblib.dump(rf_classifier, 'preimpactClassifier_rf.pkl', compress=9)
