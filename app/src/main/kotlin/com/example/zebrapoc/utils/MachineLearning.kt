...
class MachineLearning {
     ...
     * @return
     */
    fun detectEvents(ts: ArrayList<Long>, tsvDataset: ArrayList<Double>, dtsvDataset: ArrayList<Double>) {
        var noiseZones: ArrayList<String> = ArrayList()
        var detectedEvents: ArrayList<String> = ArrayList()
